            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-3">
                {["very-unsatisfied", "unsatisfied", "neutral", "satisfied", "very-satisfied"].map((value) => (
                  <label 
                    key={value} 
                    className={`relative flex flex-col items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-secondary/80 ${
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {["too-easy", "just-right", "challenging", "too-difficult"].map((value) => (
                  <label
                    key={value}
                    className={`relative flex items-center p-3 border rounded-lg cursor-pointer transition-colors hover:bg-secondary/80 ${
